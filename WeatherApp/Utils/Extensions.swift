...
extension Color {
    ...
    static let tapBarBackground = LinearGradient(gradient: Gradient(colors: [Color("Tab Bar Background 1").opacity(0.26), Color("Tab Bar Background 2").opacity(0.26)]), startPoint: .top, endPoint: .bottom)
    ...
    static let tapBarBorder = Color("Tab Bar Border").opacity(0.5)
    static let forcecastCardBackground = Color("Forecast Card Background")
